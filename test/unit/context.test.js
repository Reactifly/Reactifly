...
describe('context', () =>
{
	...
	it('should preserve provider context between different providers', () =>
	{
		...
		} = reactifly.createContext();
		const { Provider: DataProvider, Consumer: DataConsumer } = reactifly.createContext();
	...
	it('should not emit when value does not update', () =>
	{
		...
		class NoUpdate extends reactifly.Component
		{
	...
	it('should preserve provider context through nested components', () =>
	{
		...
		class Consumed extends reactifly.Component
		{
			render(props)
			{
		...
		class InnerMost extends reactifly.Component
		{
			render()
			{
				return (
	...
	it('should keep the right context at the right "depth"', () =>
	{
		...
		class Nested extends reactifly.Component
		{
			render(props)
			{
				return (
	...
	describe('class.contextType', () =>
	{
		...
		it('should restore legacy context for children', () =>
		{
			...
			class NewContext extends reactifly.Component
			{
				render()
				{
			...
			class OldContext extends reactifly.Component
			{
				getChildContext()
				{
					return { foo: 'foo' };
		...
		it('should order updates correctly', () =>
		{
			const events = [];
			let update;
			const Store = reactifly.createContext();
	...
	it('should rerender when reset to defaultValue', () =>
	{
		...
		class Provider extends reactifly.Component
		{
			constructor(props)
			{
				super(props);
